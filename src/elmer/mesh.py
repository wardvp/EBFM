...
class Mesh():
    ...
    lon: NDArray[np.float64]          # longitude coordinates of vertices in radians, ordering follows local ids [0,1,...,n_vertices-1]
    lat: NDArray[np.float64]          # latitude coordinates of vertices in radians, ordering follows local ids [0,1,...,n_vertices-1]
    ...
    def __init__(self, x_vertices: NDArray[np.float64], y_vertices: NDArray[np.float64], z_vertices: NDArray[np.float64], cell_to_vertex: NDArray[np.int_], vertex_ids: NDArray[np.int_], cell_ids: NDArray[np.int_]):
